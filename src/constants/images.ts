...
export const pklayTicker = imageLocation.concat('/images/token/pklay_ticker.svg');
...
export const NamedAlap2 = imageLocation.concat('/images/alap-389.png');
export const NamedAlap3 = imageLocation.concat('/images/alap-572.png');
...
export const NamedAlap9 = imageLocation.concat('/images/alap-777.png');
